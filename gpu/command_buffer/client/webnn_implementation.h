...
#ifndef GPU_COMMAND_BUFFER_CLIENT_WEBNN_IMPLEMENTATION_H_
...
class WEBNN_IMPLEMENTATION_EXPORT WebNNImplementation final : public WebNNInterface,
 ...
 public:
  ...
  WebNNImplementation(const WebNNImplementation&) = delete;
  WebNNImplementation& operator=(const WebNNImplementation&) = delete;

  ~WebNNImplementation() override;
...
#include "gpu/command_buffer/client/webnn_implementation_autogen.h"
 ...
 private:
  ...
  scoped_refptr<WebnnWireServices> webnn_wire_;
...
#endif  // GPU_COMMAND_BUFFER_CLIENT_WEBNN_IMPLEMENTATION_H_
