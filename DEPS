...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '16144e1a157e10ebd0c8890efdd67526bc4add86',
  # Three lines of non-changing comments so that
  ...
  'boringssl_revision': '5ce7022394055e183c12368778d361461fe90a6e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nacl_revision': 'a9e27d5c7f1b6edf7371edab79e104578d62c4f5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'cbc960899a68fecd002e96a520dbd5c3cb3367da',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@199cfeb385a2b322bbe00bd6b5710c3bfc865f69',
  ...
  'src/third_party/libinference_engine/dldt': {
    'url': 'https://github.com/fujunwei/dldt.git@85d9993b79e4f07caeb7bc44c19109510af9d65d',
